 ...
 */
final class Version20200313141609 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD produit_id INT NOT NULL, CHANGE quantite quantite INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE produit DROP panier_id, DROP prix');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP produit_id, CHANGE quantite quantite INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD panier_id INT DEFAULT NULL, ADD prix INT NOT NULL');
